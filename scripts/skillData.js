...
SkillDatas = {
	...
	0x1a: new SkillData("ADDITION_ALL",
    	"我方全體{14}{3}秒內增加{1:2p}%攻擊、{2:2p}%防禦、{4:2p}%攻擊速度{5}{15}",
    	["未使用", "攻擊增加", "防禦增加", "持續時間", "攻擊速度", "擊退力增加", "未使用", "未使用", "未使用", "未使用"],
        ["Buff旗標", "未使用"],
        ["職業旗標", "未使用"]),
	0x19: new SkillData("ADDITION_OWN",
    	"自身{3}秒內增加{1:2p}%攻擊、{2:2p}%防禦、{4:2p}%攻擊速度{5}{15}",
    	["未使用", "攻擊增加", "防禦增加", "持續時間", "攻擊速度", "擊退力增加", "未使用", "未使用", "未使用", "未使用"],
        ["Buff旗標", "未使用"],
        ["未使用", "未使用"]),
	...
	3: new SkillData("ATTACK_AREA",
    	"對自身前方{4}單位為中心，範圍{2}單位內敵人造成{1:2f}倍{15}傷害{3}{14}",
	...
	0x4d: new SkillData("CHANGE_FORM",
        ...
        ["未使用", "未使用"],
        ["未使用", "未使用"]),
    0x5d: new SkillData("CHANGE_FORM2",
    	"變身{0}，攻擊次數增加{2}次，單次攻擊增加{3}下{4}{5}",
	...
	0x33: new SkillData("DAMAGE_AREA",
    	"展開以前方{16:3f}單位為中心，高{14:3f}寬{15:3f}單位的領域，使領域內所有{17}{18}{10}，持續{4}秒",
    	["傷害倍率", "傷害間隔", "領域範圍參數", "影響目標種類", "持續時間", "傷害增加", "受傷增加", "未使用", "未使用", "未使用"],
        ["攻擊旗標", "未使用"],
        ["未使用", "未使用"]),
	0x13: new SkillData("DAMAGED_ATTACK",
    	"對自身周圍{2}單位內的敵人造成最大HP{1:2p}%的傷害，並對自己造成最大HP{3:2p}%的{15}傷害{14}，同時在{0}秒內增加{4:2p}%攻擊，{5:2p}%減傷，{6:2p}%移動速度",
    	["持續時間", "對敵傷害", "範圍", "自身傷害", "攻擊增加", "減傷增加", "移動速度增加", "未使用", "未使用", "未使用"],
        ["攻擊旗標", "未使用"],
        ["未使用", "未使用"]),
	0x5b: new SkillData("DAMAGED_ATTACK_ALL",
    	"對所有敵人造成{1:2f}倍攻擊+{2:2p}%最大HP的{15}傷害{14}，並對自己造成最大HP{3:2p}%的傷害{4}",
    	["未使用", "攻擊倍率", "血量傷害倍率", "自身傷害", "擊退力", "未使用", "未使用", "未使用", "未使用", "未使用"],
        ["攻擊旗標", "未使用"],
        ["未使用", "未使用"]),
	20: new SkillData("DAMAGED_SHOOT",
    	"對直線上單體敵人造成{1:2f}倍{15}傷害{14}，並對自身造成最大HP{3:2p}%傷害，同時在{0}秒內增加{4:2p}%攻擊，{5:2p}%減傷，{6:2p}%移動速度",
	...
	0x20: new SkillData("HEAL_DEFENSE",
    	"治療我方全體{15}{1:2f}倍血量，並增加{2:2p}%防禦，持續{3}秒{14}",
	...
	0x1f: new SkillData("HEAL_POWER",
    	"治療我方全體{15}{1:2f}倍血量，並增加{2:2p}%攻擊，持續{3}秒{14}",
    	["未使用", "治療倍率", "攻擊增加", "持續時間", "免疫時間", "未使用", "未使用", "未使用", "未使用", "未使用"],
        ["治療旗標", "未使用"],
        ["職業旗標", "未使用"]),
	0x2e: new SkillData("HEAL_STRENGTH",
    	"治療我方全體{15}{1:2f}倍血量，並增加{2:2p}%攻擊，{3:2p}%防禦，持續{4}秒{14}",
	...
	0x1c: new SkillData("HEAL_WEAK",
    	"治療我方{15}最低血量者{1:2f}倍血量，並增加{2:2p}%攻擊，{3:2p}%防禦，持續{4}秒{14}",
    	["未使用", "治療倍率", "攻擊增加", "防禦增加", "持續時間", "免疫時間", "未使用", "未使用", "未使用", "未使用"],
        ["治療旗標", "未使用"],
        ["職業旗標", "未使用"]),
	...
	0x2b: new SkillData("KNUCKLE_RUSH",
    	"近戰單體{3}回{1:2f}倍{15}傷害（間隔{2}秒）{14}，再近戰單體{4:2f}倍{15}傷害{14}{5}",
	...
	0x17: new SkillData("LOCKED_SUPPORT",
    	"歌舞{3}秒，我方全體增加{1:2p}%攻擊、{2:2p}%防禦、{4:2p}%移動速度、{5:2p}%爆擊率、{6:2p}%攻擊速度{14}",
	...
	0x44: new SkillData("MANA_CYCLE",
    	"在{4}秒內增加{1:2p}%攻擊、{2:2p}%減傷、{3:2p}%移動速度、{7:2p}%爆擊率、{8:2p}%爆擊傷害，增加攻擊速度{9:2p}%{14}，如果時間結束時擊殺至少{15}名敵人，則會返還{16}點同職法力",
	...
	0x52: new SkillData("SHOOT_CHAIN",
    	"射出{6:2f}倍速度的箭矢，對直線上單體造成{1:2f}倍{15}傷害{14}{4}，再對長{5}單位、寬{5}單位內由近至遠的{3}名敵人造成{15}傷害{14}{4}，每串一個人傷害便乘{2:3f}倍。",
	...
	13: new SkillData("SUPPORT_ALL",
    	"我方全體{14}增加{1:2p}%攻擊、{2:2p}%防禦、{6:2p}%移動速度{5}，攻擊間隔變為原本的{4:2p}%，持續{3}秒",
	...
	14: new SkillData("SUPPORT_RANDOM",
    	"我方全體{14}隨機一人增加{1:2p}%攻擊、{2:2p}%防禦、{6:2p}%移動速度{5}，攻擊間隔變為原本的{4:2p}%，持續{3}秒",
    	["未使用", "攻擊增加", "防禦增加", "持續時間", "攻擊間隔乘數", "擊退力增加", "移動速度增加", "未使用", "未使用", "未使用"],
        ["未使用", "未使用"],
        ["職業旗標", "未使用"]),
