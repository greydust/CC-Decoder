...
SkillDatas = {
	...
	65: new SkillData("SUPPORT_PLUS",
    	"使我方{6}增加{0:2p}%攻擊、{1:2p}%減傷、{2:2p}%移動速度、{4:2p}%攻擊速度{10}，持續{3:3f}秒",
    	["攻擊增加", "減傷減少", "移動速度增加", "持續時間", "攻擊速度上升", "未使用", "目標型態", "未使用", "未使用", "未使用"],
        ["減益旗標", "未使用"],
        ["職業旗標", "未使用"]),
	...
	69: new SkillData("HIGHJUMP_TARGET",
    	"跳躍並造成前方{14}單位，半徑{15}單位內隨機{3}名敵人{1:2f}倍{10}傷害{6}",
