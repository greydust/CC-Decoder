...
SkillDatas = {
	0x4c: new SkillData("ADD_FUNNEL",
    	"召喚{2}隻生物，每{0}秒一擊，對{4}{3}目標造成{1}倍{15}傷害{14}，移動速度{8}，持續{7}秒",
    	["每擊間隔", "傷害倍率", "生物數", "對象範圍", "目標型態", "未使用", "未使用", "持續時間", "移動倍率(基礎8單位)", "未使用"],
        ["攻擊旗標", "未使用"],
        ["未使用", "未使用"]),
	0x56: new SkillData("ADD_FUNNEL2",
    	"召喚{2}隻生物（最高{5}隻），每{0}秒一擊，對{4}{3}目標造成{1}倍{16}傷害{14}{15}，移動速度{8}，持續{7}秒",
	...
	1: new SkillData("ATTACK_REPEAT",
    	"近戰單體每{2}秒一回{1}倍{15}傷害{14}，共計{3}回",
	...
	0x35: new SkillData("BOMB_THROW",
    	"向前方{2}單位丟擲一顆持續時間{3}秒，觸發半徑{1}單位的炸彈，爆發時造成{0}倍{15}傷害{14}{5}，連鎖爆炸時傷害再乘上{4}倍",
	...
	0x53: new SkillData("CHARGE_SHOOT",
   	...
   	0x5c: new SkillData("CHARGE_SPREAD", 
    	"原地集氣並在點擊後射出，擊中時爆炸並傷害範圍內所有人，每{3}秒累積一層，最多累積{4}層。造成{1}倍{15}傷害{14}{5}，爆炸範圍高{7}x2、寬{7}，每一層傷害再增加{2}倍。集滿時造成{16}倍{17}傷害{18}{6}，爆炸範圍高{8}x2、寬{8}",
	...
	0x13: new SkillData("DAMAGED_ATTACK",
    	"對自身周圍{2}單位內的敵人造成最大HP{1:1p}%的傷害，並對自己造成最大HP{3:1p}%的{15}傷害{14}，同時在{0}秒內增加{4:1p}%攻擊，{5:1p}%防禦，{6:1p}%移動速度",
    	["持續時間", "對敵傷害", "範圍", "自身傷害", "攻擊增加", "防禦增加", "移動速度增加", "未使用", "未使用", "未使用"],
        ["攻擊旗標", "未使用"],
        ["未使用", "未使用"]),
	0x5b: new SkillData("DAMAGED_ATTACK_ALL",
    	"對所有敵人造成{1}倍攻擊+{2:1p}%最大HP的{15}傷害{14}，並對自己造成最大HP{3:1p}%的傷害{4}",
    	["未使用", "攻擊倍率", "血量傷害倍率", "自身傷害", "擊退力", "未使用", "未使用", "未使用", "未使用", "未使用"],
        ["攻擊旗標", "未使用"],
        ["未使用", "未使用"]),
	20: new SkillData("DAMAGED_SHOOT",
    	"對直線上單體敵人造成{1}倍{15}傷害{14}，並對自身造成最大HP{3:1p}%傷害，同時在{0}秒內增加{4:1p}%攻擊，{5:1p}%防禦，{6:1p}%移動速度",
	...
	0x20: new SkillData("HEAL_DEFENSE",
    	"治療我方全體{15}{1}倍血量，並增加{2:1p}%防禦，持續{3}秒{14}",
	...
	0x1f: new SkillData("HEAL_POWER",
    	"治療我方全體{15}{1}倍血量，並增加{2:1p}%攻擊，持續{3}秒{14}",
    	["未使用", "治療倍率", "攻擊增加", "持續時間", "免疫時間", "未使用", "未使用", "未使用", "未使用", "未使用"],
        ["治療旗標", "未使用"],
        ["職業旗標", "未使用"]),
	0x2e: new SkillData("HEAL_STRENGTH",
    	"治療我方全體{15}{1}倍血量，並增加{2:1p}%攻擊，{3:1p}%防禦，持續{4}秒{14}",
	...
	0x1c: new SkillData("HEAL_WEAK",
    	"治療我方{15}最低血量者{1}倍血量，並增加{2:1p}%攻擊，{3:1p}%防禦，持續{4}秒{14}",
    	["未使用", "治療倍率", "攻擊增加", "防禦增加", "持續時間", "免疫時間", "未使用", "未使用", "未使用", "未使用"],
        ["治療旗標", "未使用"],
        ["職業旗標", "未使用"]),
	...
	0x44: new SkillData("MANA_CYCLE",
    	"在{4}秒內增加{1:1p}%攻擊、{2:1p}%減傷、{3:1p}%移動速度、{7:1p}%爆擊率、{8:1p}%爆擊傷害，降低攻擊間隔{9}秒{14}，如果時間結束時擊殺至少{15}名敵人，則會返還{16}點同職法力",
	...
	0x49: new SkillData("MODE_LAUNCHER",
    	"在前方{16}單位處展開半徑{17}大小的砲陣，點擊時可開砲，對目標造成{2}倍{15}傷害{14}{4}、並對半徑{3}內的敵人造成{1}倍{15}傷害{14}{4}，最多可砲擊{6}次，每次至少間隔{7}秒，持續{5}秒",
    	["攻擊範圍", "攻擊倍率", "直擊攻擊倍率", "擴散半徑", "擊退力", "持續時間", "次數", "攻擊間隔", "未使用", "未使用"],
        ["攻擊旗標", "未使用"],
        ["未使用", "未使用"]),
	...
	13: new SkillData("SUPPORT_ALL",
    	"我方全體{14}增加{1:1p}%攻擊、{2:1p}%防禦、{4:1p}%攻擊速度、{6:1p}%移動速度{5}，持續{3}秒",
    	["未使用", "攻擊增加", "防禦增加", "持續時間", "攻擊速度增加", "擊退力增加", "移動速度增加", "未使用", "未使用", "未使用"],
        ["未使用", "未使用"],
        ["職業旗標", "未使用"]),
	0x57: new SkillData("SUPPORT_AREA",
    	"在前方{14}單位處展開寬{15}單位、高{16}單位的領域，每{8}秒增加{1}%攻擊、{2}%防禦{18}，最高{3}%攻擊、{4}%防禦。增益持續{17}秒，領域持續{7}秒",
    	["是否跟隨施法者移動", "攻擊增加", "防禦增加", "最大攻擊增加", "最大防禦增加", "增益旗標", "未使用", "領域持續時間", "增益間隔時間", "範圍"],
        ["未使用", "未使用"],
        ["未使用", "未使用"]),
	12: new SkillData("SUPPORT_OWN",
    	"自身增加{1:1p}%攻擊、{2:1p}%防禦、{4:1p}%攻擊速度、{6:1p}%移動速度、{5}擊退力，持續{3}秒",
    	["未使用", "攻擊增加", "防禦增加", "持續時間", "攻擊速度增加", "擊退力增加", "移動速度增加", "未使用", "未使用", "未使用"],
        ["未使用", "未使用"],
        ["未使用", "未使用"]),
	...
	14: new SkillData("SUPPORT_RANDOM",
    	"我方全體{14}隨機一人增加{1:1p}%攻擊、{2:1p}%防禦、{4:1p}%攻擊速度、{6:1p}%移動速度{5}，持續{3}秒",
    	["未使用", "攻擊增加", "防禦增加", "持續時間", "攻擊速度增加", "擊退力增加", "移動速度增加", "未使用", "未使用", "未使用"],
        ["未使用", "未使用"],
        ["職業旗標", "未使用"]),
