...
SkillDatas = {
	...
	20: new SkillData("DAMAGED_SHOOT",
    	"對直線上單體敵人造成{1:2f}倍{15}傷害{14}，並對自身造成最大HP{3:1p}%傷害，同時在{0}秒內增加{4:1p}%攻擊，{5:1p}%防禦，{6:1p}%移動速度",
	...
	0x49: new SkillData("MODE_LAUNCHER",
    	"在前方{16}單位處展開半徑{17}大小的砲陣，點擊時可開砲，對目標造成{2:2f}倍{15}傷害{14}{4}、並對半徑{3}內的敵人造成{1:2f}倍{15}傷害{14}{4}，最多可砲擊{6}次，每次至少間隔{7}秒，持續{5}秒",
