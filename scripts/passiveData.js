...
PassiveDatas = {
    ...
    0x3a: new PassiveData("Guts",
        "當受到{0}點以上的致命傷害時，有{5}次的機會抵抗該傷害、將血量回復到{4}、並無敵三秒，同時增加攻擊{1:1p}%、防禦{3:1p}%、移動速度{2:1p}%，持續{6}秒",
    ...
    0x16: new PassiveData("KillUp",
        "殺死敵人時提高{1:1p}%攻擊、{3:1p}%防禦、{2:1p}%移動速度，並治療自身最大血量{4:1p}%的傷害",
        ["未使用", "攻擊增加", "移動速度增加", "防禦增加", "回復百分比", "未使用", "未使用", "未使用", "未使用", "未使用"],
        ["未使用", "未使用"],
        ["未使用"]),
    0x47: new PassiveData("KillUpPlus",
        "殺死{13}敵人時提高{1:1p}%攻擊、{3:1p}%防禦、{2:1p}%移動速度、{5:1p}%暴擊率、{6:1p}%暴擊傷害，持續{4}秒，並治療自身最大血量{7:1p}%的傷害",
