...
PassiveDatas = {
    ...
    15: new PassiveData("Resist",
        "受到魔法攻擊時傷害乘{1:3f}倍，物理攻擊時傷害乘{0:3f}倍",
        ["物理受傷倍率", "魔法受傷倍率", "未知參數", "未知參數", "未知參數", "未知參數", "未知參數", "未知參數", "未知參數", "未知參數"],
        ["未使用", "未使用"],
        ["未使用", "未使用"]),
    ...
    19: new PassiveData("StrengthHealer",
        "使治療量乘{1:3f}倍、治療速度乘{2:3f}倍{5}{10}{14}",
        ["治療範圍增加", "治療量倍率", "治療速度倍率", "治療範圍樣式", "治療範圍", "是否為攻擊型", "未使用", "未使用", "未使用", "未使用"],
        ["治療旗標", "未使用"],
        ["未使用", "未使用"]),
    ...
    57: new PassiveData("HitNormal",
        "普攻{0}下後，普攻攻擊乘{1:3f}倍、必殺攻擊乘{2:3f}倍、移動速度乘{3:3f}倍、受傷乘{4:3f}倍{14}，持續{5:3f}秒，效果內再普攻可刷新效果",
    ...
    65: new PassiveData("WaveSupportAll",
        "過Wave時，使戰場上所有{12}角色的攻擊增加{1:2p}%、移動速度乘{1:3f}倍、減傷增加{3:2p}%、暴擊機率增加{4:2p}%{10}{0}",
        ["持續時間", "攻擊增加", "移動速度倍率", "減傷減少", "暴擊增加", "未使用", "未使用", "未使用", "未使用", "未使用"],
        ["治療旗標", "未使用"],
        ["職業旗標", "未使用"]),
    ...
    76: new PassiveData("StrengthHome",
        ...
        ["所屬", "攻擊倍率", "移動速度倍率", "受傷倍率", "暴擊機率增加", "普攻上狀態機率", "暴擊上狀態機率", "必殺上狀態機率", "未使用", "未使用"],
        ["攻擊旗標", "未使用"],
        ["職業旗標", "未使用"]),
    ...
    80: new PassiveData("HoldMana",
        "當{14}珠數≧{0}時，攻擊乘{1:3f}倍、移動速度乘{2:3f}倍、受傷乘{3:3f}倍、暴擊機率增加{7:2p}%、暴擊傷害增加{8:2p}%{15}",
        ["需求數量", "攻擊倍率", "移動速度倍率", "受傷倍率", "治療比例", "治療間隔", "是否需要所有職業都符合", "暴擊機率增加", "暴擊傷害增加", "未使用"],
        ["未使用", "未使用"],
        ["職業旗標", "未使用"]),
    ...
    98: new PassiveData("WaveShield",
        "過Wave時，使戰場上{14}{12}獲得{1:3f}倍攻擊力的護盾，持續{2}次{10}",
    ...
    104: new PassiveData("EventPointUp",
        "在活動{0}中戰功率獲取增加{1:2p}%",
        ["活動編號", "戰功倍率", "未知參數", "未知參數", "未知參數", "未使用", "未使用", "未使用", "未使用", "未使用"],
        ["未使用", "未使用"],
        ["未使用", "未使用"]),
