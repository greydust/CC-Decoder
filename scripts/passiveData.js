...
PassiveDatas = {
    ...
    0x3f5: new PassiveData("MoveUp",
        "在角色移動時疊加增益，每{0}單位一層，最高{7}層。每一層增加{1:1p}%普攻傷害、{2:1p}%必殺傷害、{3:1p}%移動速度、{4:1p}%防禦、{5:1p}%暴擊機率，持續{6}秒，不移動{8}時開始倒數{13}",
        ["多少距離一層", "普攻傷害增加", "必殺傷害增加", "移動速度增加", "防禦增加", "暴擊率增加", "時間限制", "最大層數", "是否不動作才開始倒數", "未使用"],
        ["攻擊旗標", "未使用"],
        ["未使用"]),
    ...
    0x3f8: new PassiveData("StopUp",
        "原地不動時每{1}秒得到一層增益，最高{0}層。每一層增加{2:1p}%攻擊、{3:1p}%減傷、{4:1p}%暴擊機率、{5:1p}%暴擊傷害、{6}攻擊間隔",
        ["最大層數", "多久一層", "攻擊增加", "減傷增加", "暴擊機率增加", "暴擊傷害增加", "攻擊間隔增加", "未使用", "未使用", "未使用"],
        ["未使用", "未使用"],
        ["未使用"]),
