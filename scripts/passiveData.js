...
PassiveDatas = {
    ...
    8: new PassiveData("Always",
        ...
        ["未使用", "攻擊倍率", "未使用", "受傷倍率", "血量倍率", "未使用", "未使用", "未使用", "未使用", "未使用"],
        ["未使用", "未使用"],
        ["未使用"]),
    ...
    0x3ed: new PassiveData("ChangeFormUp",
        "變身時，攻擊乘{1:3f}倍、移動速度乘{2:3f}倍、受傷乘{3:3f}倍、暴擊機率增加{4:2p}%、暴擊傷害增加{5:2p}%、攻擊速度乘{6:3f}倍，近戰範圍增加{0:2p}%{13}，並每{7:1f}秒治療最大血量的{8:2p}%，每殺一個人可以延長變身時間{9:3f}秒",
        ["近戰範圍增加", "攻擊倍率", "移動速度倍率", "受傷倍率", "暴擊機率增加", "暴擊傷害增加", "攻擊速度倍率", "治療間隔", "治療比例", "殺人延長時間"],
        ["攻擊旗標", "未使用"],
        ["未使用"]),
    ...
    0x22: new PassiveData("FlagUp",
        "當自己受到{13}狀態影響時，攻擊乘{1:3f}倍、移動速度乘{2:3f}倍、受傷乘{3:3f}倍{14}，必殺法力珠消耗減少{7:d}顆",
        ["未使用", "攻擊倍率", "移動速度倍率", "受傷倍率", "治療比例", "治療間隔", "未使用", "必殺法力珠消耗減少", "未使用", "未使用"],
        ["Debuff旗標", "未使用"],
        ["未使用"]),
    ...
    0x43: new PassiveData("HeroOne",
        "當{13}的角色數量≧{0}時，攻擊乘{1:3f}倍、移動速度乘{2:3f}倍、受傷乘{3:3f}倍、暴擊機率增加{6:2p}%、暴擊傷害增加{7:2p}%，必殺法力珠消耗減少{9:d}顆",
        ["數量需求", "攻擊倍率", "移動速度倍率", "受傷倍率", "未使用", "未使用", "暴擊機率增加", "暴擊傷害增加", "所屬", "必殺法力珠消耗減少"],
        ["武器旗標", "未使用"],
        ["職業旗標"]),
    ...
    0x2a: new PassiveData("Invisible",
        "使自身隱形，隱形時每{4}秒使{0}增加{1:2p}%攻擊、{2:2p}%移動速度、{3:2p}%減傷，持續{5}秒{6}",
    ...
    0x4c: new PassiveData("StrengthHome",
        "使戰場上所有{13}角色的攻擊乘{1:3f}倍、移動速度乘{2:3f}倍、受傷乘{3:3f}倍、暴擊機率增加{4:2p}%",
        ["所屬", "攻擊倍率", "移動速度倍率", "受傷倍率", "暴擊機率增加", "未使用", "未使用", "未使用", "未使用", "未使用"],
        ["未使用", "未使用"],
        ["職業旗標"]),
    ...
    0x4b: new PassiveData("StrengthWeapon",
        "使戰場上所有{14}持{13}武的角色攻擊乘{1:3f}倍、移動速度乘{2:3f}倍、受傷乘{3:3f}倍、暴擊機率增加{4:2p}%，並每{6:3f}秒治療最大血量的{5:2p}%",
        ["是否包含自己", "攻擊倍率", "移動速度倍率", "受傷倍率", "暴擊機率增加", "治療比例", "治療間隔", "未使用", "未使用", "未使用"],
        ["武器旗標", "未使用"],
        ["未使用"]),
    ...
    0x3eb: new PassiveData("SuperSkillFull",
        "當超必殺計量條滿時，攻擊乘{1:3f}倍、移動速度乘{2:3f}倍、受傷乘{3:3f}倍、暴擊機率增加{4:2p}%、暴擊傷害增加{5:2p}%、攻擊速度乘{6:3f}倍、治療量增加{7:2p}%{13}",
        ["未使用", "攻擊倍率", "移動速度倍率", "受傷倍率", "暴擊機率增加", "暴擊傷害增加", "攻擊速度倍率", "治療量增加", "未使用", "未使用"],
        ["攻擊旗標", "未使用"],
        ["未使用"]),
