...
PassiveDatas = {
    ...
    0x37: new PassiveData("BugManaAttack",
        "依法力珠數，0珠時攻擊乘{0:3f}倍，至8珠時攻擊乘{1:3f}倍",
        ["0珠時攻擊倍率", "8珠時攻擊倍率", "未知參數", "未知參數", "未知參數", "未知參數", "未知參數", "未知參數", "未知參數", "未知參數"],
        ["未使用", "未使用"],
        ["未使用"]),
    ...
    0x3e: new PassiveData("ManaAttack",
        "依法力珠數，0珠時攻擊乘{0:3f}倍，至8珠時普攻攻擊乘{1:3f}倍。使用必殺後，0珠時必殺攻擊乘{2:3f}倍，至8珠時必殺攻擊乘{3:3f}倍",
